 ...
 *
 * - Use 'Planobject.extend({ ... prototype ... });' to create a new class
 * - Use 'Planobject.create({ ... instance members ... });' to create a new instance
 ...
 * @returns {child}
 */
Planobject.extend = function (proto, stat) {
 ...
 */
Planobject.create = function(def) {
 ...
 * @ignore
 */
module.exports = Planobject.extend({ init: K });